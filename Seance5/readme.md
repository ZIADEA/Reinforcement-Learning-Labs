...
- [gridworld_env/gridworld_env/grid_core.py](gridworld_env/gridworld_env/grid_core.py)  
  Logique interne de la grille (indexation, déplacement de l’agent, gestion des goals, récompenses, etc.).

- [gridworld_env/gridworld_env/grid_sb3_env.py](gridworld_env/gridworld_env/grid_sb3_env.py)  
...
- [gridworld_env/gridworld_env/__init__.py](gridworld_env/gridworld_env/__init__.py)  
...
Dans le dossier du zoo : [rl-baselines3-zoo](rl-baselines3-zoo)

- [rl-baselines3-zoo/train.py](rl-baselines3-zoo/train.py)  
  Script d’entraînement générique du zoo (appelé via `python -m rl_zoo3.train`).

- [rl-baselines3-zoo/test_gridworld_ppo.py](rl-baselines3-zoo/test_gridworld_ppo.py)  
  Script maison pour :
...
- [rl-baselines3-zoo/cartpole_sb3_view.py](rl-baselines3-zoo/cartpole_sb3_view.py)  
...
- [rl-baselines3-zoo/hyperparams/ppo.yml](rl-baselines3-zoo/hyperparams/ppo.yml)  
...
* Static :
  [rl-baselines3-zoo/logs/ppo/GridWorldStatic-v0_1](rl-baselines3-zoo/logs/ppo/GridWorldStatic-v0_1)
...
* Moving entraîné **directement depuis PPO vierge** :
  [rl-baselines3-zoo/logs/ppo/GridWorldMoving-v0_1](rl-baselines3-zoo/logs/ppo/GridWorldMoving-v0_1)

* Moving **finetuné à partir du modèle Static** (cas “raté”) :
  [rl-baselines3-zoo/logs/ppo/GridWorldMoving-v0_1_fintune_sur_gridword_static](rl-baselines3-zoo/logs/ppo/GridWorldMoving-v0_1_fintune_sur_gridword_static)

* CartPole :
  [rl-baselines3-zoo/logs/ppo/CartPole-v1_1](rl-baselines3-zoo/logs/ppo/CartPole-v1_1)
  Et copie du modèle dans :
  [models/ppo/CartPole-v1/CartPole-v1.zip](models/ppo/CartPole-v1/CartPole-v1.zip)
...
* Static :
  [rl-baselines3-zoo/logs/logs_tensorboard_ppo_gridworld_static/GridWorldStatic-v0/PPO_1](rl-baselines3-zoo/logs/logs_tensorboard_ppo_gridworld_static/GridWorldStatic-v0/PPO_1)

* Moving finetuné sur Static :
  [rl-baselines3-zoo/logs/logs_tensorboard_ppo_gridworld_moving_fintune_sur_gridword_static/GridWorldMoving-v0/PPO_1](rl-baselines3-zoo/logs/logs_tensorboard_ppo_gridworld_moving_fintune_sur_gridword_static/GridWorldMoving-v0/PPO_1)

* Moving entraîné directement :
  [rl-baselines3-zoo/logs/logs_tensorboard_ppo_gridworld_finetune_moving/GridWorldMoving-v0/PPO_1](rl-baselines3-zoo/logs/logs_tensorboard_ppo_gridworld_finetune_moving/GridWorldMoving-v0/PPO_1)

* CartPole :
  [rl-baselines3-zoo/logs/test_cartpole_tb/PPO_1](rl-baselines3-zoo/logs/test_cartpole_tb/PPO_1)

Un zip global est également présent :
[rl-baselines3-zoo/logs/tensorbord.zip](rl-baselines3-zoo/logs/tensorbord.zip)
...
```bash
python -m rl_zoo3.train --algo ppo --env GridWorldStatic-v0 \
    -n 100000 \
    --tensorboard-log logs/ppo/
```
...
```bash
python -m rl_zoo3.train --algo ppo --env GridWorldMoving-v0 \
...
Pour un aperçu rapide, comparer les GIF dans [gridworld_runs/](gridworld_runs) :
